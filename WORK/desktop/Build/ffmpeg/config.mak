...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix='C:/Users/Coral/Desktop/CoralPhone-desktop/OUTPUT/desktop' --arch=i386 --target-os=mingw32 --prefix='C:/Users/Coral/Desktop/CoralPhone-desktop/OUTPUT/desktop' --arch=i386 --target-os=mingw32 --prefix='C:/Users/Coral/Desktop/CoralPhone-desktop/OUTPUT/desktop' --arch=i386 --target-os=mingw32 --disable-static --enable-shared --disable-doc --disable-zlib --disable-bzlib --disable-ffplay --disable-ffprobe --disable-ffserver --disable-avdevice --disable-avfilter --disable-network --disable-avformat --disable-everything --enable-decoder=mjpeg --enable-encoder=mjpeg --disable-vda --disable-vaapi --disable-vdpau --ar='C:/MinGW/bin/ar.exe' --cc='C:/MinGW/bin/gcc.exe' --nm='C:/MinGW/bin/nm.exe' --extra-cflags=' -D_WIN32_WINNT=0x0600 -D_CRT_SECURE_NO_WARNINGS -D_WINSOCK_DEPRECATED_NO_WARNINGS -D_ALLOW_KEYWORD_MACROS  -include windows.h -w' --extra-cxxflags=' -D_WIN32_WINNT=0x0600 -D_CRT_SECURE_NO_WARNINGS -D_WINSOCK_DEPRECATED_NO_WARNINGS -D_ALLOW_KEYWORD_MACROS ' --extra-ldflags='  -static-libgcc' --enable-runtime-cpudetect
prefix=C:/Users/Coral/Desktop/CoralPhone-desktop/OUTPUT/desktop
...
SRC_PATH=/c/Users/Coral/Desktop/CoralPhone-desktop/linphone-sdk/external/ffmpeg
ifndef MAIN_MAKEFILE
SRC_PATH:=$(SRC_PATH:.%=..%)
endif
CC_IDENT=gcc 8.2.0 (MinGW.org GCC-8.2.0-3)
ARCH=x86
CC=C:/MinGW/bin/gcc.exe
CXX=g++
AS=C:/MinGW/bin/gcc.exe
LD=C:/MinGW/bin/gcc.exe
DEPCC=C:/MinGW/bin/gcc.exe
YASM=yasm
YASMDEP=yasm
...
CFLAGS= -D_WIN32_WINNT=0x0600 -D_CRT_SECURE_NO_WARNINGS -D_WINSOCK_DEPRECATED_NO_WARNINGS -D_ALLOW_KEYWORD_MACROS -include windows.h -w  -std=c99 -fno-common -fomit-frame-pointer -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
CXXFLAGS= -D_WIN32_WINNT=0x0600 -D_CRT_SECURE_NO_WARNINGS -D_WINSOCK_DEPRECATED_NO_WARNINGS -D_ALLOW_KEYWORD_MACROS -D__STDC_CONSTANT_MACROS
ASFLAGS= -D_WIN32_WINNT=0x0600 -D_CRT_SECURE_NO_WARNINGS -D_WINSOCK_DEPRECATED_NO_WARNINGS -D_ALLOW_KEYWORD_MACROS -include windows.h -w  -g
AS_O=-o $@
CC_O=-o $@
CXX_O=-o $@
LDFLAGS= -static-libgcc -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil
...
VCODEC_TESTS=amv cljr dnxhd_720p_10bit flashsv2 jpeg2000 ljpeg mjpeg mpng msvideo1 prores qtrle qtrlegray v210 vref zlib zmbv 
LAVF_TESTS=caf dpx jpg rso sox voc_s16 wtv 
